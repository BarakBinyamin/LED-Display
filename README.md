...
<img src= images/7.jpg width="50%">  this is the view if it were to be looked from behind, this image is flipped and should not reflect the orientation of the final result 
